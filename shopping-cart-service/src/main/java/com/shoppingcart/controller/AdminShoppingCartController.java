...
public class AdminShoppingCartController {
    ...
    public ResponseEntity<ShoppingCartResponse> genDiscountCode(@RequestBody ShoppingCartRequest shoppingCartRequest) throws ShoppingCartException, JsonProcessingException {
    ...
    @PostMapping("/report")
    public ResponseEntity<ShoppingCartResponse> getReport(@RequestBody ShoppingCartRequest shoppingCartRequest) throws ShoppingCartException, JsonProcessingException {
        logger.info("adding to shopping cart");
